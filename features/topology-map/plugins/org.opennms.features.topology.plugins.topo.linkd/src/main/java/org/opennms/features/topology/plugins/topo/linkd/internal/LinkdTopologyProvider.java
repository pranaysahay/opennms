...
public class LinkdTopologyProvider extends AbstractTopologyProvider implements GraphProvider {
    ...
    private void getLldpLinks() {
        ...
        for (Pair<LldpLink, LldpLink> pair : matchedLinks) {
            ...
            SnmpInterfaceTopologyEntity sourceSnmpInterface = getSnmpInterface(sourceLink.getNode().getId(), sourceLink.getLldpPortIfindex());
            SnmpInterfaceTopologyEntity targetSnmpInterface = getSnmpInterface(targetLink.getNode().getId(), targetLink.getLldpPortIfindex());
    ...
    private void getOspfLinks() {
        ...
        for (Pair<OspfLink, OspfLink> pair : matchedLinks) {
            ...
            SnmpInterfaceTopologyEntity sourceSnmpInterface = getSnmpInterface(sourceLink.getNode().getId(), sourceLink.getOspfIfIndex());
            SnmpInterfaceTopologyEntity targetSnmpInterface = getSnmpInterface(targetLink.getNode().getId(), targetLink.getOspfIfIndex());
            connectVertices(getDefaultEdgeId(sourceLink.getId(), targetLink.getId()),
                    source,target,
                    sourceSnmpInterface,targetSnmpInterface,
    ...
    private void getIsIsLinks() {
        ...
        for(Pair<IsIsLink, IsIsLink> pair : results) {
            ...
            SnmpInterfaceTopologyEntity sourceSnmpInterface = getSnmpInterface(sourceLink.getNode().getId(), sourceLink.getIsisCircIfIndex());
            SnmpInterfaceTopologyEntity targetSnmpInterface = getSnmpInterface(targetLink.getNode().getId(), targetLink.getIsisCircIfIndex());
            connectVertices(getDefaultEdgeId(sourceLink.getId(), targetLink.getId()),
                source, target,
                sourceSnmpInterface, targetSnmpInterface,
