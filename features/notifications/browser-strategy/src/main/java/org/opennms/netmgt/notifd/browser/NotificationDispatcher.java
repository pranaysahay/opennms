...
public class NotificationDispatcher {
    ...
    public static class Handler {
        ...
        public final Consumer<NotificationMessage> consumer;

        private Handler(final String user,
                        final Consumer<NotificationMessage> consumer) {
    ...
    public Handler subscribe(final String user, final Consumer<NotificationMessage> consumer) {
    ...
    public void notify(final String user, final NotificationMessage notification) {
        this.handlers.stream()
                .filter(handler -> handler.user.equals(user))
                .forEach(handler -> handler.consumer.accept(notification));
    }

    private final static NotificationDispatcher INSTANCE = new NotificationDispatcher();
