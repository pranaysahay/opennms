...
public class NodeMapsApplication extends UI {
    ...
    private static final int REFRESH_INTERVAL = SystemPropertiesUtils.getInteger("org.opennms.features.nodemaps.refresh", 30*1000);
    ...
    protected void init(final VaadinRequest vaadinRequest) {
        ...
        final Integer maxClusterRadius = SystemPropertiesUtils.getInteger("gwt.maxClusterRadius", 350);
