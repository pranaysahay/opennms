...
public class NotificationStreamServlet extends WebSocketServlet {
    ...
    public NotificationStreamServlet() {
        final BeanFactoryReference bf = BeanUtils.getBeanFactory("browserNotificationContext");
        // this.dispatcher = Objects.requireNonNull(BeanUtils.getBean(bf, "notificationDispatcher", NotificationDispatcher.class));
    ...
    public class NotificationStreamSocket extends WebSocketAdapter {
        ...
        private NotificationDispatcher.Handler handler;
        ...
        public void onWebSocketConnect(final Session session) {
            ...
            this.handler = NotificationStreamServlet.this.dispatcher.subscribe(this.user, this::sendNotification);
        }

        @Override
        public void onWebSocketClose(final int statusCode, final String reason) {
            super.onWebSocketClose(statusCode, reason);
            NotificationStreamServlet.this.dispatcher.unsubscribe(this.handler);
        }
        ...
        private void sendNotification(final NotificationMessage message) {
            // TODO fooker: Send some JSON
            try {
                this.getRemote().sendString(message.getBody());
